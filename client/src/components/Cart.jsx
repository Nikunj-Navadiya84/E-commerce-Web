                ...
                <AnimatePresence>
                    {selectedProduct && (
                        <motion.div
                            ...
                            <motion.div
                                className='bg-white max-h-[90vh] p-6 rounded-lg shadow-lg w-full max-w-lg sm:max-w-xl md:max-w-2xl relative'
                                initial={{ scale: 0.7 }}
                                animate={{ scale: 1 }}
                                exit={{ scale: 0.7 }}>
                                ...
                                <div className='flex  pt-3 flex-col items-center gap-6'>
